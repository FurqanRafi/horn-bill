    ...
    return (
        <div className='w-full   px-4 sm:px-10'>
                ...
                <div className='hidden lg:flex items-center  justify-end gap-3  '>
                    ...
                    <div className=' w-1/3 flex items-center gap-2'>
                        ...
                        <div className='w-full '>
                            ...
                            <p className='text-md  text-blue-600 font-semibold font-san-serif'>House No 02, Main Service
            ...
            <nav className='hidden Mycontainer lg:flex items-center justify-center gap-20 py-6 border-t bg-[#008df2] z-10 relative border-gray-200'>
                ...
                <Link href='/contact' className='text-white text-xl hover:text-[#fab60a] font-medium'>Contact</Link>
            </nav>
